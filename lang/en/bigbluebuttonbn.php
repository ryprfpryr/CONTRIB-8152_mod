...
$string['config_skipcheckaudio_default'] = 'Skip echo test is enabled by default';
$string['config_skipcheckaudio_default_description'] = 'If enabled the echo test will be disabled';
$string['config_skipcheckaudio_editable'] = 'Skip echo test can be edited';
$string['config_skipcheckaudio_editable_description'] = 'Skip echo test by default can be edited when the instance is added or updated.';
...
$string['mod_form_field_skipcheckaudio'] = 'Skip check audio';
